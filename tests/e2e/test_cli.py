...
def test_positional_arg(path_to_pickled_model):
    exec_args = ["sykj_mtoc", "--language", "python", str(path_to_pickled_model)]
...
def test_piped(path_to_pickled_model):
    exec_args = [
        ...
        str(path_to_pickled_model), "|", "sykj_mtoc", "--language", "python"]
    execute_test(exec_args)
...
def test_dash_m(path_to_pickled_model):
    exec_args = ["python", "-m", "sykj_mtoc", "--language", "python", str(path_to_pickled_model)]
    execute_test(exec_args)
