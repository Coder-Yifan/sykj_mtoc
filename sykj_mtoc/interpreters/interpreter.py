from sykj_mtoc.assemblers import fallback_expressions
from sykj_mtoc.ast import BinNumExpr, CompExpr, IfExpr
from sykj_mtoc.interpreters.utils import CachedResult, _get_handler_name
