from sykj_mtoc.assemblers.boosting import (
    LightGBMModelAssembler,
    XGBoostLinearModelAssembler,
    XGBoostModelAssemblerSelector,
    XGBoostTreeModelAssembler
)
from sykj_mtoc.assemblers.ensemble import RandomForestModelAssembler
from sykj_mtoc.assemblers.linear import (
...
from sykj_mtoc.assemblers.meta import RANSACModelAssembler
from sykj_mtoc.assemblers.svm import LightningSVMModelAssembler, SklearnSVMModelAssembler
from sykj_mtoc.assemblers.tree import TreeModelAssembler
...
SUPPORTED_MODELS = {
    ...
    "xgboost_Booster": XGBoostModelAssemblerSelector,
