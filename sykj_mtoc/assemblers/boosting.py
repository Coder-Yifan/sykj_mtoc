...
from sykj_mtoc.assemblers import utils
from sykj_mtoc.assemblers.base import ModelAssembler
from sykj_mtoc.assemblers.linear import _linear_to_ast
...
class BaseBoostingAssembler(ModelAssembler):
    ...
    def _assemble_single_output(self, estimator_params, base_score=0.0, split_idx=0):
        ...
        if base_score != 0.0 and base_score is not None:
    ...
    def _assemble_bin_class_output(self, estimator_params):
        ...
        base_score = 0.0
        if self._base_score != 0.0 and self._base_score is not None:
